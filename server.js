...
var db=mongoose.connect('mongodb+srv://@clustermongodb.net/?retryWrites=true&w=majority',{useNewUrlParser: true,useUnifiedTopology: true,useCreateIndex: true},()=>{
...
app.get("/libraryuser.ejs",(req,res)=>{
     books.find({},(err,data)=>{
        if (err){
            console.log(err)
        }
...
// userlibrary page
app.get("/userlibrary.ejs",(req,res)=>{
    books.find({},(err,data)=>{
        if (err){
            console.log(err)
        }
